...
'transit.home': never,
'transit.routes': never,
'transit.routes.show': {
route: string | number,
},
'api.routes.index': never,
'api.routes.show': {
route: string | number,
},
'api.stops.search': never,
'api.stops.nearest': never,
'api.trips.search': never,
'profile.edit': never,
...
const routes = {
    ...
    "transit.home": "buscar",
    "transit.routes": "rutas",
    "transit.routes.show": "rutas/{route}",
    "api.routes.index": "api/routes",
    "api.routes.show": "api/routes/{route}",
    "api.stops.search": "api/stops/search",
    "api.stops.nearest": "api/stops/nearest",
    "api.trips.search": "api/trips/search",
